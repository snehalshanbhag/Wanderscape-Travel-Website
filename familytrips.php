...
<h2 align="center">FAMILY TRIPS</h2>
...
<div class="row" >
	...
	<div class="col">
		<div class="box">
			...
			<div class="content">
				...
				<p>Budget:46700/- per person</p>
				<p>Attraction:Temples,Mountains,Climate</p>
	...
	<div class="col">
		<div class="box">
			...
			<div class="content">
				<h2>Visit Egypt</h2></a>
				<p>Budget:46700/- per person</p>
				<p>Attraction:Desert,Pyramids,Climate</p>
	...
	<div class="col">
		<div class="box">
			<div class="imgBx">
				<a href="maldives.php" style="text-decoration: none;"><img src="images/mal.jpg">
			</div>
			<div class="content">
				<h2>Visit Maldives</h2></a>
				<p>Budget:46700/- per person</p>
				<p>Attraction:Resorts,Beaches,Climate</p>
	...
	<div class="col">
		<div class="box">
			<div class="imgBx">
				<a href="newzealand.php" style="text-decoration: none;"><img src="images/new.jpg">
			</div>
			<div class="content">
				<h2>Visit New Zealand</h2></a>
				<p>Budget:46700/- per person</p>
				<p>Attraction:Mount Cook,Beaches,Climate</p>
				<p>Best time to visit:Overall year</p>
			</div>
		</div>
	</div>
